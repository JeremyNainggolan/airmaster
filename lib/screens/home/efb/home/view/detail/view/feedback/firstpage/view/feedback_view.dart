...
class Feedback_View extends GetView<Feedback_Controller> {
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      log(
                        'Feedback submitted: q1-${controller.q1.value}, q2-${controller.q2.value}, q3-${controller.q3.value}, q4-${controller.q4.value}, q5-${controller.q5.value}, q6-${controller.q6.value}',
                      );
                      Get.toNamed(
