...
class TC_TrainingHistory extends GetView<TC_TrainingHistory_Controller> {
  const TC_TrainingHistory({super.key});
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Card(
                              ...
                              child: ListTile(
                                onTap: () {
                                  Get.toNamed(AppRoutes.DETAIL_TRAINING_HISTORY, arguments: controller.trainingHistory[index]);
                                },
